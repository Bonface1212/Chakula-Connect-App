// lib/screens/donor/chat_screen.dart
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
//import 'package:ChakulaConnect/screens/donors/donor_dashboard.dart.dart';

class DonorChatScreen extends StatefulWidget {
  final String receiverId;
  final String receiverName;

  const DonorChatScreen({super.key, required this.receiverId, required this.receiverName});
...
class _DonorChatScreenState extends State<DonorChatScreen> {
  ...
  void _setupChatId() {
    // Consistent chat ID for both users
